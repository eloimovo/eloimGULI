package com.eloim.msm.service.impl;
...
public class MsmServiceImpl implements MsmService {
    ...
    public boolean sendMsm(HashMap<String, Object> map, String phone) {
        ...
        DefaultProfile profile = DefaultProfile.getProfile("default", "LTAI5tHGBxnikfMphLdQtNTv", "c8ATDBzSZ10qzUGh5mmMtUF0qelnIj");
        ...
        request.putQueryParameter("SignName","eloim的谷粒教育网站");//申请阿里云短信服务的【签名名称】
        request.putQueryParameter("TemplateCode","SMS_217438668");//申请阿里云短信服务的【模版中的 模版CODE】
